...
<body style="background-image: url(jos.jpg); background-repeat: no-repeat; background-position: center;background-size: cover;">
 ...
 <?php  
				...
				?>
				 <?php  
					...
					if(isset($notif))
					{
						if($notif=="open")
						{
							$var = "<script>alert('Reached The Maximum Respondent For Booking')</script>";
					print $var;
				?>
				<?php  
						}
 	...
 	<header class="header" style="background-color: #03482b;">
      ...
      <ul class="main-nav">
          <li><a href="dashboard1.php" style="color: white;">Home</a></li>
          <li><a href="index2	.php"  onclick="return confirmdel();" style="color: white;">logout</a></li>
      </ul>
	</header> 
<div class="bgpic">
<center>
			...
			<div class="design">
				<?php 
					$script ="SELECT id FROM tbl_bookingform order by id"; 
