...
require_once(myClass."_myclass.php");
	...
	$script="SELECT * FROM tbl_approved WHERE Name='$Name'";
	...
	$script ="INSERT into tbl_approved (datein,Name,CompleteAddress,DateofBooking,DayofBooking,ContactNumber,Email,Picture)
		values(
		'$datein',
		'$Name',
		'$CompleteAddress',
	...
	{
		$script ="INSERT into tbl_approved (datein,Name,CompleteAddress,DateofBooking,DayofBooking,ContactNumber,Email)
		values(
		'$datein',
		'$Name',
		'$CompleteAddress',
